...
const SolicitudesTable = () => {
  ...
  const handleOpenConfirm = (id, accion) => {
    setModalConfirm({ visible: true, id, accion });
  };
              ...
              <tr key={row.id}>
                ...
                <td className="text-center">
                  <button
                    ...
                    onClick={() => handleOpenConfirm(row.id, "Aprobado")}
                  >
                  ...
                  <button
                    ...
                    disabled={estado !== "Pendiente"}
                    onClick={() => handleOpenConfirm(row.id, "Rechazado")}
                  >
